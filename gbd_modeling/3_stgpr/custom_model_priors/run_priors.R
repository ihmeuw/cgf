...
launch_prior <- function(me, decomp_step, crosswalk_version_id=NA, path_to_data=NA, test_mods=TRUE, average=TRUE, pred_ages,
  ...
  rmse_output <- paste0("filepath")  # where the object returned by test_prior is saved
  data_output <- paste0("filepath")
  ensemble_output <- paste0("filepath")
  plot_mods_path <- paste0("filepath") 
